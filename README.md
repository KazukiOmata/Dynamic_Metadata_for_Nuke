...
構成変更、デバック
- 25/11/16 v1.2.5
rotation orderのdebug
- 25/11/16 v1.2.6
Read Nodeの名前でCamera Nodeを作成できるように追加
SONY RawViewerのroll +-をNukeの+-に合わせた
...
- Use Read node name for Camera node :
Camera NodeをRead nodeのclip nameにするか、DynamicMetadatraCamにするか
